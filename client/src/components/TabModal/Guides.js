...
const Guides = () => {
  ...
  const langsel = lang === 'EN'? 'Language ': '語言 ';
  const guidex = () => {
    return(
    lang === 'EN'?
      <span>
        ...
        The copepods are small and similar. Follow the links of classification key in order and find how these copepods are classified.<br/>
      ...
      <span>
        ...
        橈足類體型微小，外型相似，按網頁上分類索引的鍵值連結便可依序掌握分類的關鍵<br/>
